    ...
    return (
        <>
            ...
            <div className='flex flex-col pt-10 px-6 space-y-2  lg:items-center lg:space-y-8 lg:pt-20'>
                ...
                <div className='flex flex-col items-start mt-7 space-y-1 lg:flex-row  lg:justify-center lg:space-x-20 lg:px-5 lg:w-full'>
                    <div>
                        <img src='/image 8.png' className='lg:w-48'></img>
