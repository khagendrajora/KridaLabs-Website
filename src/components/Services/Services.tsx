...
export const Services = () => {
    return (
        <>
            <div className='w-full flex flex-row py-12 pl-16'>
                <div className='left p-7 w-1/4 z-20 flex flex-row items-center  '>
                    ...
                    <div className='bg-servicesLeft p-5 w-40 h-36  space-y-10 rounded-tl-[90px]'>
                        ...
                        <p className='w-[450px]'>We build readymade websites, mobile applications, and elaborate online business services</p>

                        <div className='grid grid-rows-8 grid-flow-col gap-3 z-0'>
                            <div className='bg-serviceRight w-2 h-2 rounded'></div>
                            <div className='bg-serviceRight w-2 h-2 rounded'></div>
                            <div className='bg-serviceRight w-2 h-2 rounded'></div>
                            <div className='bg-serviceRight w-2 h-2 rounded'></div>
                            <div className='bg-serviceRight w-2 h-2 rounded'></div>
                ...
                <div className='right w-full z-10'>
                    <div className='bg-serviceRight  h-[560px] rounded-tl-[150px]'>
